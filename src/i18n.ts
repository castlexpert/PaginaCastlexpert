...
export const copy: Record<Language, AppCopy> = {
  es: {
    hero: {
      ...
      recommendation: 'Desarrollo a medida para tu operación real',
      revenueLabel: 'Ingresos',
      growthStat: 'Proceso claro: idea, diseño, entrega y soporte',
      activeClients: 'Comunicación directa con el equipo del proyecto',
      navCta: 'Empezar',
      languageButton: 'EN',
    },
    services: {
  ...
  en: {
    hero: {
      ...
      recommendation: 'Custom development for how your business actually works',
      revenueLabel: 'Revenue',
      growthStat: 'Clear process: idea, design, delivery, and support',
      activeClients: 'Direct communication with the project team',
      navCta: 'Get started',
      languageButton: 'ES',
    },
    services: {
