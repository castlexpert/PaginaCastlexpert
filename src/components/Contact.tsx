    ...
    <section id="contact" className="py-24 relative overflow-hidden bg-[#f7f3eb]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="p-8 cx-card">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-lg cx-card-surface flex items-center justify-center flex-shrink-0">
        ...
        <form onSubmit={handleSubmit} className="p-8 md:p-12 rounded-3xl cx-card cx-card-hover shadow-xl shadow-black/5">
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg bg-white/15 border border-emerald-400/55 text-black placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-400/80 transition-all"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-lg bg-white/15 border border-emerald-400/55 text-black placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-400/80 transition-all resize-none"
